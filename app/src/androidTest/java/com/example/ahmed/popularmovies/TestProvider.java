...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                MovieContract.MovieEntry.buildMovieReview(123));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals(
        ...
        type = mContext.getContentResolver().getType(MovieContract.ReviewsEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.sunshine.app/location
        assertEquals("Error: the ReviewsEntry CONTENT_URI should return ReviewsEntry.CONTENT_TYPE",
                     MovieContract.ReviewsEntry.CONTENT_TYPE, type);
    }
    ...
    public void testBasicWeatherQuery() {
        ...
        long reviewRowId = TestUtilities.insertDummyReviewValues(mContext);

        // Fantastic.  Now that we have a location, add some weather!
        ContentValues movieValues = TestUtilities.createMovieValues(reviewRowId);
        ContentValues testValues2 = TestUtilities.createDummyReview2();
        reviewRowId = TestUtilities.insertDummyReviewValues2(mContext);
        movieValues = TestUtilities.createMovieValues(reviewRowId);


        long movieRowId = db.insert(MovieContract.MovieEntry.TABLE_NAME, null, movieValues);
        assertTrue("Unable to Insert MovieContract.MovieEntry into the Database", movieRowId != -1);
...
//
//        ContentValues testValues = TestUtilities.createDummyReview();
//        long locationRowId = TestUtilities.insertDummyReviewValues(mContext);
//
//        // Test the basic content provider query
...
//                    locationCursor.getNotificationUri(), MovieContract.ReviewsEntry.CONTENT_URI);
//        }
//    }
//
//    /*
...
//        ContentValues values = TestUtilities.createDummyReview();
//
//        Uri locationUri = mContext.getContentResolver().
//                insert(MovieContract.ReviewsEntry.CONTENT_URI, values);
...
//        updatedValues.put(MovieContract.ReviewsEntry._ID, locationRowId);
//        updatedValues.put(MovieContract.ReviewsEntry.COLUMN_CITY_NAME, "Santa's Village");
//
//        // Create a cursor with observer to make sure that the content provider is notifying
//        // the observers as expected
//        Cursor locationCursor = mContext.getContentResolver().query(MovieContract.ReviewsEntry.CONTENT_URI, null, null, null, null);
//
//        TestUtilities.TestContentObserver tco = TestUtilities.getTestContentObserver();
//        locationCursor.registerContentObserver(tco);
//
//        int count = mContext.getContentResolver().update(
//                MovieContract.ReviewsEntry.CONTENT_URI, updatedValues, MovieContract.ReviewsEntry._ID + "= ?",
...
//                MovieContract.ReviewsEntry.CONTENT_URI,
//                null,   // projection
//                MovieContract.ReviewsEntry._ID + " = " + locationRowId,
...
//        Uri locationUri = mContext.getContentResolver().insert(MovieContract.ReviewsEntry.CONTENT_URI, testValues);
//
...
//        );
//
//        TestUtilities.validateCursor("testInsertReadProvider. Error validating MovieContract.ReviewsEntry.",
//                cursor, testValues);
//
//        // Fantastic.  Now that we have a location, add some weather!
...
//        mContext.getContentResolver().registerContentObserver(MovieContract.ReviewsEntry.CONTENT_URI, true, locationObserver);
//
...
//        );
//
//        TestUtilities.validateCursor("testBulkInsert. Error validating MovieContract.ReviewsEntry.",
//                cursor, testValues);
//
